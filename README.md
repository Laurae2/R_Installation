...
"alr4", "amap", "Amelia", "anchors", "animation", "AnomalyDetection", 
"aod", "aods3", "ape", "aplpack", "argparse", "arimaUI", "arm", 
"arules", "arulesViz", "ascii", "assertthat", "AUC", "BaBooN", 
"backports", "barcode", "bartMachine", "bartMachineJARs", "base", 
...
"compiler", "CompQuadForm", "compute.es", "conf.design", "config", 
...
"dataframes2xls", "datasets", "date", "dbConnect", 
...
"elmNN", "emdbook", "emoa", "emulator", "energy", "ENmisc", "EnQuireR", 
...
"grDevices", "GREA", "grid", "gridBase", "gridExtra", "grouped", 
...
"ks", "labeling", "labelled", "labeltodendro", "laeken", "LaF", 
...
"mvnormtest", "mvoutlier", "mvtnorm", "namebrowser", "NbClust", 
...
"oz", "packrat", "pageviews", "pamr", "pan", "pander", "parallel", 
...
"rgl", "Rglpk", "rglwidget", "RgoogleMaps", "rgp", "rgpui", "RGtk2", 
...
"roxygen2", "rpanel", "rpart", "rpart.plot", "rpf", "rpivotGadget", 
...
"scales", "scalreg", "scatterplot3d", "scrypt", "sda", "SEL", 
...
"shinyCustom", "shinyjs", "shinystan", "shinythemes", "signal", 
...
"tibble", "tidyr", "tidyselect", "tidyshiny", "tikzDevice", "timeDate", 
"timereg", "timeSeries", "tis", "tkrplot", "tm", "TMB", "tmvtnorm", 
"tnam", "tools", "TransferEntropy", "translations", "tree", "trimcluster", 
"tripack", "truncdist", "truncnorm", "truncreg", "trust", "TSA", 
"tseries", "tseriesEntropy", "tsna", "TSP", "TTR", "tufte", "tuneR", 
"tweedie", "ucminf", "uniReg", "unmarked", "urca", "utils", "uuid", 
...
"wordcloud", "WrapRmd", "WrightMap", "WriteXLS", 
